...
- [APRAKSTS.txt](APRAKSTS.txt) - Full project description (Latvian)
...
**Paula:** Domain model, frontend UI, hard constraints, REST API, base solver configuration  
...
**Course:** Combinatorial Optimization, University of Latvia
